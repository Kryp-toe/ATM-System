...
REM Generate JavaDoc for project for all subpackages.
:JAVADOC
echo ~~~ Generate JavaDoc for project ~~~
javadoc %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOC%\%PRAC_JDC% -subpackages com
IF /I "%ERRORLEVEL%" NEQ "0" (
